...
package com.winning.bi.view.component.common.autoSuggest
{
...
public class AutoCompleteModified extends ComboBox 
{
	...
	private function defaultFilterFunction(element:*, text:String):Boolean 
	{
	    ...
	    var py:HanZi2PinYin=new HanZi2PinYin();
	    return py.toPinyin(label).toLocaleLowerCase().indexOf(py.toPinyin(text).toLocaleLowerCase()) != -1;
//	    return label.toLocaleLowerCase().indexOf(text.toLocaleLowerCase()) != -1;
