package com.winning.bi.view.component.flexdev.diagrammer {
	...
	public class Link extends UIComponent {
		...
		protected function getMidlePoint():Point {
			if(this.fromNode==this.toNode)
			{
				var x:Number =this.fromNode.x+this.fromNode.width/2;
				var y:Number =this.fromNode.y-40;
		...
		protected function handleLabelLink(event:LabelLinkEvent):void {
			...
			Diagram(parent).handleLinkNameChanged(this);
		}
		...
		protected function handleClick(event:MouseEvent):void {
			...
			if(!diagram.isLinking && !diagram.contains(this.linkContextPanel)) {
				...
				this.linkContextPanel.width = 79;
				this.linkContextPanel.height = 45;
		...
		protected function drawLine(fromNodeCenterPoint:Point, toNodeCenterPoint:Point, bottomColor:uint, topColor:uint):void {
			...
			if(this.toNode == null) {
				...
				point1 = new Point(this.fromNode.x+20,this.fromNode.y);
				point2 = new Point(this.fromNode.x+this.fromNode.width-20,this.fromNode.y);
			} 
			else {
			...
			if(this.toNode==this.fromNode){
				...
				this.graphics.curveTo(point1.x-20,point1.y-20,point1.x,point1.y-40);
				this.graphics.lineTo(point2.x, point2.y-40);
				this.graphics.curveTo(point2.x+20, point2.y-20,point2.x, point2.y);
				...
				drawArrow(point2.x+20, point2.y-20, point2.x, point2.y, bottomColor, topColor);
			}else{
				//For easy event handling a transparent stronger line
				this.graphics.lineStyle(this.getStyle("lineThickness")+8, bottomColor, 0.1);
				this.graphics.moveTo(point1.x, point1.y);
