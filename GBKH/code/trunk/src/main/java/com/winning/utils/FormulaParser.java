...
public class FormulaParser
{
	...
	public double getResult()
	{
		...
		if (!initValid(this.formula))
		{
			throw new BusinessException("公式中存在非法字符,请检查公式！");
		}
		...
		{
			throw new BusinessException("公式配置有误,请检查公式！");
		}
	...
	public boolean initValid(String formula)
	{
		boolean flag = true;
		if (formula != null && formula.length() > 0)
		{
			...
			{
				if (!charList.contains("" + formula.charAt(i)))
				{
					flag = false;
					break;
				}
	...
	public static void main(String[] args)
	{
		...
		fp.setFormula("-3&*100/6");
		// System.out.println (fp.initValid ("-3&*100/6"));
		System.out.println(fp.getResult());
		// org.apache.poi.ss.formula.FormulaParser fp=new
		// org.apache.poi.ss.formula.FormulaParser("(1+2)*100/0", null,
		// leftBracket);
	}
}
