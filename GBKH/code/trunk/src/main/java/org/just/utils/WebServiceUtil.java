...
public class WebServiceUtil
{
	public static Service getWebService(String url, String serviceClassName)
	{
		...
		{
			Process ls_proc = run
					.exec("wsimport -B-XautoNameResolution -d "+new PathUtil().getRealPath()+File.separator+"WEB-INF"+File.separator+"classes"+" -keep -p org.just.xch.service.webservice.client "
							+ url +" -extension");
			String ls_str;
			...
			return (Service)Class.forName(
					"org.just.xch.service.webservice.client."
